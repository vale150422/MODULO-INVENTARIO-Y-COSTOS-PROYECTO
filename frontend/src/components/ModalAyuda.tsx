...
import {
  LayoutDashboard, Leaf, Users, Tag, ShoppingCart, Store,
  Package, ClipboardList, BarChart2, UserCircle, Home,
...
const seccionesAdmin = [
  ...
  },
  {
    ...
    pasos: [
      ...
      'Haz clic en "Imprimir / Exportar PDF" para generar el reporte imprimible.',
    ],
  },
  {
    icon: BarChart2,
  ...
  },
  {
    ...
    pasos: [
      'Puedes editar tu nombre haciendo clic en el botón Editar junto al campo Nombre.',
...
const seccionesEmpleado = [
  ...
  },
  {
    ...
    pasos: [
      ...
      'Haz clic en "Imprimir / Exportar PDF" o usa Ctrl+P para generar el PDF.',
    ],
  },
];
